...
结果表明，$\alpha$是本研究四个设计变量中对基底接触压力影响最为显著的参数。$\alpha$从0°增大至20°，$P_{sub,AWA}$从5733~Pa增至22184~Pa，增幅高达287\%。值得注意的是，该增长过程并非线性：在$\alpha \leq 15°$范围内，压力随$\alpha$的增大较为平稳；而在$\alpha$从15°增至20°时，压力出现非线性激增（由12081~Pa至22184~Pa，单步增幅+84\%），呈现明显的临界加速行为。
